    ...
    return (   
        ...
        :
            ...
            <motion.div initial='hidden' animate='show' variants={containerVariants} className='center'>
                <motion.form variants={itemVariants} className='rounded-2xl w-full py-2 relative' action={(e) => { if(![0, 1, 2, 3, 4, 5].includes(quality)) {return;} setQuality(-1); action(e); handle();}}>
