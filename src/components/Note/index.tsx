...
export default function Note({
  ...
  return (
    <div
      className="relative box-layout !p-4 max-h-[720px] sm:max-h-[800px] mt-8 enter-fade"
    ...
    >
      <div
        className="absolute flex flex-col items-center top-3.5 right-0 rounded-2xl w-[100px]"
        title="Menu"
      >
        <button
          type="button"
