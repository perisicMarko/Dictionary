...
import { decryptAccess, decryptRefresh, encryptAccess, verifySession,  } from '@/actions/manageSession';
...
export async function POST(req : NextRequest){
    ...
    if(retVal === STATUS.UNAUTHORIZED){ //unauthorized
        ...
        await saveNotes(data.word, data.audio, data.userNotes, data.generatedNotes, userId);  
        ...
        const payload = await decryptAccess(data.accessToken);
