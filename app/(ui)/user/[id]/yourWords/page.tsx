...
export default function YourWords(){
    ...
    return (
        ...
        <div className='rounded-4xl mt-10 b-2 text0-blue-950 bg-blue-400 b-blue-950'>
            <input className="bg-blue-400 text-blue-950 rounded-4xl" type="text" name="search" placeholder="Search words here..." value={search} onChange={(e) => { setSearch(e.target.value) }}/>
        </div>
