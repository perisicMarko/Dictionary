    ...
    <>
        <nav className="bg-blue-400 block w-full rounded-4xl h-[50px]">
          <div className="flex justify-start my-3 ml-10">
            ...
            <Link href={'/user/' + id} className="ml-340  bg-blue-950 hover:bg-blue-400 hover:scale-110 cursor-pointer rounded-full border-2 text-blue-50 px-3"> Home page </Link>
