...
export default function Page(){
    ...
    return (
        ...
        :
            <motion.div initial='hidden' animate='show' variants={itemVariants} className='bg-slate-800 w-3/4 sm:w-[600px] rounded-2xl mt-10'>
                <div className='rounded-t-2xl flex justify-end bg-slate-950'>
                    <span className="xBtn mr-3 text-white py-1" onClick={() => {setHelp(false);}}><b>x</b></span>
                </div>
                <h2 className="text-white text-center mt-1"><b>Here is where you recall your words</b></h2>
                <motion.p variants={itemVariants} className="p-4 text-white">
                    Click on the menu icon to open the menu.
                    In menu there are edit and delete icons, also &quot;notes&quot; for showing word notes and &quot;grade&quot; for grading ui, grading ui is initialy selected.<br/><br/>
                    <b>How this works?</b><br/>
                    Recall system is based on forgetting curve and spaced repetition algorithm.<br/>
                    When you add a new word it is set to recall for the next day, that is the first repetition. After the first one the second one is after 6 days. When you have done first two repetitions each next is calculated based on how good you have graded your recall.
        ...
        :
        <motion.div initial='hidden' animate='show' variants={itemVariants} className="center bg-slate-800 w-3/4 sm:w-[600px] mt-60 rounded-4xl p-2">
            <h2 className="text-center text-white w-3/4 sm:w-[600px]"><b>Hmm, looks like you do not have any words to recall for today, keep up the good work!</b></h2>
        </motion.div>
        }
        </>
    );
