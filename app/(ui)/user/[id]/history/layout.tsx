    ...
    <>
        <nav className="bg-slate-900 w-full h-[50px] grid grid-cols-[auto_1fr] items-center">
          <div className="flex justify-start items-center xl:ml-5 ml-2">
            <form action={logOut}>
              <button className="hover:scale-115 scale-105 cursor-pointer ml-2"> <Image src='/logOut.svg' alt='logOut icon' width={20} height={20}></Image> </button>
            </form>
          </div>
            <div className="flex justify-end items-center xl:space-x-5 mr-2 sm:mr-5">
              ...
              <Link id='layoutLearnedLink' href={'/user/' + id + '/history'} className="py-1 px-1 sm:px-3 navigationBtn text-blue-400"> Learned words </Link>
            </div>
        </nav>
