    ...
    return (
        <div className="mt-10 m-5 sm:w-[650px] bg-blue-400 rounded-2xl border-2 border-blue-50 overflow-auto">
            ...
            <div className='p-2'>
                ...
                Repetitions will reset if you mark word as not recalled good enough, you will have range 1-5. Not good enough is everything below the 3 so 0, 1 and 2.
                </p>
                <h3 className='title'>More informations on the app are on every page dedicated help link.</h3>
            </div>
        </div>
    )
}